...
<div class='paper-box'><div class='paper-box-image'><div><img src='images/papers/trainee-bench.png' alt="Trainee-Bench" width="100%"></div></div>
<div class='paper-box-text' markdown="1">
...
<div class='paper-box'><div class='paper-box-image'><div><img src='images/papers/kg-traces.png' alt="KG-Traces" width="100%"></div></div>
<div class='paper-box-text' markdown="1">
...
<a class="pub-link" href="https://github.com/Edaizi/KG-TRACES"><i class="fab fa-github"></i>Code</a>
<a class="pub-link" href="https://huggingface.co/papers/2506.00783"><img class="hf-icon" src="https://huggingface.co/front/assets/huggingface_logo-noborder.svg" alt="">HuggingFace</a>

- Supervises LLM reasoning with KG-constrained trajectories and attribution-aware explanations for traceable reasoning.
</div></div>

<span class='anchor' id='ai4sci'></span>
